				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-lg-8">
								{{ Form::open(array('url'=>url('user', array($user->id)), 'method'=>'put', 'class'=>'form-horizontal user-form', 'enctype'=>'multipart/form-data')) }}
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											{{ Form::select('role', array('principal'=>'Principal', 'administrator'=>'Administrator'), Input::old('role', $user->role), array('id'=>'role', 'class'=>'')) }}
										</div>
									</div>
