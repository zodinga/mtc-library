					...
					<div class="panel-body">
						...
						<ol>
							...
							<li>
								...
								</b><small class="created_at">added on {{date('d M Y, h:iA', strtotime($book->created_at))}}</small></p>
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div class="row">
																		<div class="col-sm-12">
																			<?php 
																			$issues = Transaction::where('book_id','=',$book->id)->whereRaw("returned_at is null")->get();
