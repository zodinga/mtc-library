						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								...
								<div class="form-group {{($errors->has('classification_no'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('classification_no', Input::old('classification_no',$book->classification_no), array('autocomplete'=>'off', 'id'=>'classification_no', 'class'=>'form-control')) }}
							...
							<div class="col-lg-6 col-md-6">
								<div class="form-group {{($errors->has('category_new') || $errors->has('category_id'))?'has-error':''}}">
									...
									<div class="col-sm-6">
										<?php
										$cate = Category::find($book->category_id);
										$categories_options = array($cate->id => $cate->category_name);
								...
								<div class="form-group {{($errors->has('author_new') || $errors->has('author_id'))?'has-error':''}}">
									...
									<div class="col-sm-6">
										<?php
										$book_author = Author::find($book->author_id);
										$authors_options = array($book_author->id => $book_author->author_name);
								...
								<div class="form-group {{($errors->has('publisher_new') || $errors->has('publisher_id'))?'has-error':''}}">
									...
									<div class="col-sm-6">
										<?php
										$book_pub = Author::find($book->publisher_id);
										$publishers_options = array($book_pub->id => $book_pub->publisher_name);
								...
								<div class="form-group {{($errors->has('row_no'))?'has-error':''}}">
									...
									<div class="col-sm-8">
										{{ Form::text('row_no', Input::old('row_no',$book->shelf_no), array('autocomplete'=>'off', 'id'=>'row_no', 'placeholder'=>'', 'class'=>'form-control')) }}
