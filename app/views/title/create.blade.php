...
<div class="page-header">
	<h1>Select Book Title for Book Entry</h1>
</div>
	...
	<div class="container">
		...
		<div class="row row-demo">
			...
			<div class="col-lg-6 col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Existing Book Title for New Book</h3>
					</div>
								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php $copies = Book::where('title','=',$booktitle->id)->count('copies'); ?>{{$copies}}</td>
											<td>
			...
			<div class="col-lg-6 col-md-6">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">New Book Title Entry</h3>
					</div>

					<div class="panel-body">
						
						{{ Form::open(array('url'=>'title', 'method'=>'post', 'class'=>'form-horizontal book-form', 'enctype'=>'multipart/form-data')) }}
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="form-group {{($errors->has('title'))?'has-error':''}}">
									{{ Form::label('title', 'Book Title', array('class'=>'col-sm-4 control-label')) }}
									<div class="col-sm-8">
										{{ Form::text('title', Input::old('title'), array('autocomplete'=>'off', 'id'=>'title', 'placeholder'=>'Enter title for the book', 'class'=>'form-control','required' => 'required','title' => 'Title is required')) }}
