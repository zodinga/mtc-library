	...
	<div class="col-lg-5">
		{{ Form::open(array('url'=>url('idcard', array($idcard->id)), 'method'=>'put', 'class'=>'form-horizontal idcard-form', 'enctype'=>'multipart/form-data', 'autocomplete'=>'off')) }}
			...
			<div class="form-group {{($errors->has('fa_blood_group'))?'has-error':''}}">
				...
				<div class="col-sm-7">
					{{ Form::select('fa_blood_group', array('O+ve'=>'O+ve', 'A+ve'=>'A+ve', 'B+ve'=>'B+ve', 'AB+ve'=>'AB+ve','O'=>'O', 'A'=>'A', 'B'=>'B', 'AB'=>'AB'), Input::old('fa_blood_group', $idcard->blood_group), array('id'=>'faculty_blood_group', 'placeholder'=>'', 'class'=>'form-control')) }}
				</div>
			</div>			
