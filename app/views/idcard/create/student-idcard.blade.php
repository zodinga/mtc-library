<div class="row-fluid">
	<div class="col-lg-5">
		{{ Form::open(array('url'=>'idcard', 'method'=>'post', 'class'=>'form-horizontal idcard-form', 'enctype'=>'multipart/form-data', 'autocomplete'=>'off')) }}
			{{ Form::hidden('card_no', $rs, array('id'=>'student_card_no')) }}
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					{{ Form::select('type', array('regular student'=>'Regular Student', 'short course'=>'Short Course'), '', array('id'=>'student_class', 'class'=>'')) }}
				</div>
			</div>
			...
			<div class="form-group {{($errors->has('blood_group'))?'has-error':''}}">
				...
				<div class="col-sm-7">
					{{ Form::select('blood_group', array('O+ve'=>'O+ve', 'A+ve'=>'A+ve', 'B+ve'=>'B+ve', 'AB+ve'=>'AB+ve','O'=>'O', 'A'=>'A', 'B'=>'B', 'AB'=>'AB'), Input::old('blood_group'), array('id'=>'student_blood_group', 'placeholder'=>'', 'class'=>'form-control')) }}
				</div>
			</div>
					...
					<div id="student_idcard" class="idcard idcard-preview">
						<div class="idcard-front">
							<div class="idcard-header">
								...
								<span class="idcard-title">MISSIONARY TRAINING CENTRE <br>PRESBYTERIAN CHURH OF MIZORAM</span>
								<h3>IDENTITY CARD</h3>
							</div>
...
$(function(){
	student_generate_barcode(student_rs);
	...
	$("#student_class").change(function(){
		...
		if(student_class == 'regular student')
			student_generate_barcode(student_rs);
		else if(student_class == 'short course')
			student_generate_barcode(student_sc);
	});
